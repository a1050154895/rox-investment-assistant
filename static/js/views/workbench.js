    ...
    <div class="research-page workbench-page">
      ...
      <section class="workbench-section"><div class="section-heading"><div><span class="eyebrow">TASKS</span><h3>研究任务</h3></div><span>选择一个动作开始</span></div>
        <div class="workbench-task-grid">
          ...
          <button class="card workbench-task" data-route="/anomaly"><span class="task-kicker">RADAR</span><strong>异动雷达</strong><small>ATR 基线 + 波动率突破 + 新闻反查</small></button>
          <button class="card workbench-task" data-route="/notes"><span class="task-kicker">NOTES</span><strong>快速速记</strong><small>盘中灵感、事件快记、关联研究卡</small></button>
