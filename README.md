...
## 当前版本状态（v4.31.0 · 2026-08-28）

> 191 项后端测试、6 项移动端 E2E 全绿，Render 线上持续部署。以下为 v4.9.0 以来的主要升级：
...
- **研究工作台**：吸收 Gangtise 的任务入口与一页通组织方式，统一进入标的研究、主题研究、反证自查、复盘、知识检索和 AI 研究辅助；不改变无 AI 模式和可信数据边界。
