...
## 当前版本状态（v4.47.0 · 2026-09-06）

> 260 项后端测试、15 项移动端 E2E 全绿、15 项移动端 E2E 全绿，Render 线上持续部署。以下为 v4.9.0 以来的主要升级：
...
| 测试 | 260 个后端测试、15 个 Playwright 移动端 E2E，并接入 Lighthouse 移动审计 |
