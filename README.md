...
## 当前版本状态（v4.33.0 · 2026-08-28）

> 215 项后端测试、6 项移动端 E2E 全绿，Render 线上持续部署。以下为 v4.9.0 以来的主要升级：
...
- **异动雷达**：ATR 基线 + 波动率突破 + 成交量异动 + 新闻反查；盘前隔夜新闻 × 自选股交叉筛选；5 分钟K线盘中振幅/量能监控；异动可直接创建研究卡，把价格信号变成研究线索。不伪造资金流，以成交量/振幅异动作为代理指标。
